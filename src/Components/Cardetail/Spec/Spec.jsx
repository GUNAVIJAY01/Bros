...
return (<>
      ...
      <Box sx={{width:{xs:"100%",md:"50%"}}}>
          <Box sx={{width:"100%",display:"flex",cursor:"pointer",margin:"5px 5px"}}>
            <Box sx={{width:"50%",border:"1px solid lightgray",borderTop:{md:"none"},textAlign:"center",padding:"15px",display:"flex",alignItems:"center",justifyContent:"space-between",margin:"0 10px"}}>
            <Box>
