...
let Comparison=()=>{
    let sc=pop.map((v,ins)=>{
     ...
     let sd=pops.map((v,ins)=>{
       ...
       transfer(`/Comparisn?FirstCar=${sc}&FirstId=${Ab}&SecondCar=${sd}&SecondId=${Abc}`)     
...
return(<Container maxWidth="lg">
        ...
        {/* <p style={{textAlign:"end",color:"blue",cursor:"pointer"}} onClick={Touch}> Read more</p> */}
        </Box>
                 ...
                 <Box>
                    {arr.map((vl,ind)=>{
                        return(<Box>
                            ...
                            <Box sx={{display:"flex",width:"100%",border:"1px solid lightgray",margin:"10px",position:"relative"}}>
                                <Box sx={{position:"absolute",right:"48.5%",zIndex:"99",backgroundColor:"white",top:"38%"}}>
                               ...
                               {vl.comp?<Box  sx={{width:"50%",borderRight:"1px solid lightgray",position:"relative"}}>
                                    {pop.map((vl,ind)=>{
                                        return (<Box key={ind} sx={{textAlign:"center"}} >
                                                    <Box component="img" src={vl.CarImg} width="50%"/>
                               ...
                               <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRuuVANA4Ebo2z6TjayAv5CGRNaCTGwbgz6Q&usqp=CAU"} style={{borderRadius:"100%",margin:"0 0px 0 0px"}} width="60px" />
                                ...
                                <p style={{position:"absolute",top:"160px",right:"240px"}}>select a car</p>
                                ...
                                :
                            <Box  sx={{width:"50%",borderRight:"1px solid lightgray",position:"relative"}}>
                            <Box onClick={()=>compare(vl)} sx={{display:"flex",justifyContent:"center",alignItems:"center",height:"250px",width:"100%",textAlign:"center",cursor:"pointer"}}>
                           <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQRuuVANA4Ebo2z6TjayAv5CGRNaCTGwbgz6Q&usqp=CAU"} style={{borderRadius:"100%",margin:"0 0px 0 0px"}} width="60px" />
                            </Box>
                            <p style={{position:"absolute",top:"160px",right:"240px"}}>select a car</p>
                            </Box>}
 ...
 {compar && <Box sx={{position:{xs:"fixed",sm:"fixed",md:"fixed"},backgroundColor:"rgb(243 239 239)",height:{xs:"100%",sm:"50%",md:"50%",lg:"90%"},width:{xs:"100%",sm:"50%",md:"50%",lg:"50%"},top:{xs:"0",sm:"50%",md:"50%",lg:"7%"},right:{xs:"0",md:"30%"},bottom:{sm:"0px"},left:{sm:"0",md:"0",lg:"unset"},zIndex:"99"}}>
    ...
    <Box className="bg" sx={{width:"100%",margin:"30px 0 0 0",position:"relative"}}>
           ...
           <Container maxWidth="lg">
              <Box className="ip" sx={{position:"relative"}}>
                ...
                <Box sx={{overflow:"auto",width:{xs:"100%",sm:"100%",md:"450px",lg:"630px"},height:{xs:"700px",sm:"100%",md:"500px",lg:"380px"}}}>
...
{cmpr && <Box sx={{position:{xs:"fixed",sm:"fixed",md:"fixed"},backgroundColor:"rgb(243 239 239)",height:{xs:"100%",sm:"50%",md:"50%",lg:"90%"},width:{xs:"100%",sm:"50%",md:"50%",lg:"50%"},top:{xs:"0",sm:"50%",md:"50%",lg:"7%"},right:{xs:"0",md:"30%"},bottom:{sm:"0px"},left:{sm:"0",md:"0",lg:"unset"},zIndex:"99"}}>
